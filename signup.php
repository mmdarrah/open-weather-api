...
<input type="password" name="password_repeat" placeholder="Repeat password" required class="form-control">
<button type="submit" name="signUp-submit" class="btn btn-success">Sign up</button>
</form>
<a href="index.php" class="btn btn-warning">Back to login page</a>
</div>
</main>
